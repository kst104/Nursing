...
def configure_fonts():
    ...
    # Try using koreanize_matplotlib first (easiest for Streamlit Cloud)
    try:
        import koreanize_matplotlib
        # It automatically sets the font on import, but we can ensure it
    except ImportError:
        pass
    ...
    if system_name == 'Windows':
        ...
        # If koreanize_matplotlib worked, this might be redundant but safe
        pass
