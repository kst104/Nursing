...
def configure_fonts():
    ...
    if system_name == 'Windows':
        ...
        # 1. Try generic NanumGothic name
        plt.rc('font', family='NanumGothic')
        
        # 2. If not found, try adding font manually from common paths
        # Streamlit Cloud installs fonts to /usr/share/fonts/truetype/nanum
